...
run_non_stop = _resolve_bool_env(
    "AUTO_APPLIER_RUN_NON_STOP", False
...
run_sleep_seconds = _resolve_positive_int("AUTO_APPLIER_RUN_SLEEP_SECONDS", 300)
...
# LinkedIn runs should stay visible; do not allow env overrides to launch headless.
...
safe_mode = _resolve_bool_env(
    "AUTO_APPLIER_SAFE_MODE", True
)  # True or False, Note: True or False are case-sensitive
...
keep_screen_awake = _resolve_bool_env(
    "AUTO_APPLIER_KEEP_SCREEN_AWAKE", True
